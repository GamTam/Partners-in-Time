...
public class BMarioOverworldJumpState : BMarioOverworldBaseState, IBMarioOverworldRootState
{
    public BMarioOverworldJumpState(BMarioOverworldStateMachine currentContext, BMarioOverworldStateFactory bmarioOverworldStateFactory) 
