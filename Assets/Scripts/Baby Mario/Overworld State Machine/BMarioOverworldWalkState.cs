...
public class BMarioOverworldWalkState : BMarioOverworldBaseState
{
    private Vector3 _newMove;
    
    public BMarioOverworldWalkState(BMarioOverworldStateMachine currentContext, BMarioOverworldStateFactory bmarioOverworldStateFactory) 
