...
public class BMarioOverworldStateMachine : Billboard
{
    // Input
    ...
    //State Machine
    private BMarioOverworldBaseState _currentState;
    private BMarioOverworldStateFactory _states;
    ...
    // Getters and Setters
    public BMarioOverworldBaseState CurrentState { get { return _currentState; } set { _currentState = value; } }
    public bool BMAction { get { return _bmAction.triggered; } }
    public bool MAction { get { return _mAction.triggered; } }
    public bool LAction { get { return _lAction.triggered; } }
    ...
    private void Awake()
    {
        ...
        _lAction = _playerInput.actions["l_action"];
        ...
        // State Machine Setup
        _states = new BMarioOverworldStateFactory(this);
    ...
    private void OnControllerColliderHit(ControllerColliderHit hit) {
        if(hit.gameObject.tag == "Block" && _currentState is BMarioOverworldJumpState) {
            _velocity = 0;
